...
public class ToDoListController : ControllerBase
{
    ...
    [HttpGet("GetToDoByProject")]
    public ActionResult<IEnumerable<ReadToDoListsDTO>> GetToDoByProject(int projectId)
    {
        return _todolistManager.GetTODoByProject(projectId);
    }
